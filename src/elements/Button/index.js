...
export default function Button(props) {
    ...
    if(props.type == "link") {
        if(props.isExternal){
            return (
                <a href={props.href} className={className.join(" ")} style={props.style} target={props.target === "_blank" ? "_blank":undefined} rel={props.target === "_blank" ? "nopener noreferrer":undefined}>{props.children}</a>
            )
        } else {
            return (
